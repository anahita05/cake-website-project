      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm shadow-sm border-b border-red-100">
        <div className="max-w-6xl mx-auto px-4">
          <div className="relative flex items-center justify-between h-14 gap-4">
            ...
            <div
              className="group hidden lg:flex items-center gap-2 bg-orange-50 rounded-full px-4 py-2 border border-red-100 focus-within:border-red-700 transition-colors
            ...
            <div className="flex items-center gap-2 ml-auto md:ml-0">
              ...
              <a
                className="hidden lg:block bg-[#B83232] hover:bg-red-900 text-white text-sm font-semibold px-5 py-2 rounded-full transition-colors shadow-md cursor-pointer whitespace-nowrap"
